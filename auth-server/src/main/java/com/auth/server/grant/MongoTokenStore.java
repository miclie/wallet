...
import com.auth.server.entity.MongoAccessToken;
import com.auth.server.entity.MongoRefreshToken;
...
public class MongoTokenStore implements TokenStore {
	...
	public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String username) {
		return findTokensByCriteria(
				Criteria.where(MongoAccessToken.CLIENT_ID).is(clientId).and(MongoAccessToken.USERNAME).is(username));
	}
