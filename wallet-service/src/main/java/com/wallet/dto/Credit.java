...
public class Credit extends ResourceSupport implements Serializable {
	...
	@JsonCreator
	public Credit(@JsonProperty("name") String name) {
		super();
		this.name = name;
	}

	public Credit withLink(Link link) {
		this.add(link);
		return this;
	}
	
	public Credit withLink(String href, String rel) {
