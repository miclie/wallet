...
public class ApplicationTests {
	...
	@Test(expected = AccountBalanceCannotBeLessThanZeroException.class)
	public void spendMoneyFromAccountAccountLessThanZero()
			throws AccountNotFoundException, NoUserFoundException, TransactionNumberAlreadyExists,
			AccountBalanceCannotBeLessThanZeroException, InterruptedException, ExecutionException {

		accountService.spendMoneyFromAccount(username, new BigDecimal(15), transactionId).get();
	}
